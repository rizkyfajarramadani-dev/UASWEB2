...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  <div class="container">
	<div class="navbar-header">
	  ...
	  <a class="navbar-brand" href="admin.php"><span class="glyphicon glyphicon-list-alt"></span> APLIKASI PBS COVID-19</a>
	</div>
	  ...
	  <ul class="nav navbar-nav">
		...
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
			<li><a href="./admin.php?hlm=alokasi">Data Alokasi</a></li>
